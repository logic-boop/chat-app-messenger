...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> = {
    ...
    meta: {
      modelProps: "user" | "activeSession" | "message"
    ...
    model: {
      ...
      ActiveSession: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.ActiveSessionFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.ActiveSessionAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export type UserOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "name" | "email" | "password" | "image" | "isActive" | "createdAt" | "updatedAt", ExtArgs["result"]["user"]>
  ...
  export type ActiveSessionOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "userId" | "deviceId" | "createdAt", ExtArgs["result"]["activeSession"]>
  ...
  export interface ActiveSessionDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more ActiveSessions that matches the filter.
     * @param {ActiveSessionFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const activeSession = await prisma.activeSession.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: ActiveSessionFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a ActiveSession.
     * @param {ActiveSessionAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const activeSession = await prisma.activeSession.aggregateRaw({
     *   pipeline: [
     *     { $match: { status: "registered" } },
     *     { $group: { _id: "$country", total: { $sum: 1 } } }
     *   ]
     * })
     */
    aggregateRaw(args?: ActiveSessionAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
  ...
  interface ActiveSessionFieldRefs {
    ...
    readonly deviceId: FieldRef<"ActiveSession", 'String'>
  ...
  /**
   * ActiveSession findRaw
   */
  export type ActiveSessionFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * The query predicate filter. If unspecified, then all documents in the collection will match the predicate. ${@link https://docs.mongodb.com/manual/reference/operator/query MongoDB Docs}.
     */
    filter?: InputJsonValue
  ...
  /**
   * ActiveSession aggregateRaw
   */
  export type ActiveSessionAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * An array of aggregation stages to process and transform the document stream via the aggregation pipeline. ${@link https://docs.mongodb.com/manual/reference/operator/aggregation-pipeline MongoDB Docs}.
     */
    pipeline?: InputJsonValue[]
  ...
  export type MessageOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "body" | "image" | "createdAt" | "senderId", ExtArgs["result"]["message"]>
  ...
  export type ActiveSessionWhereInput = {
    ...
    deviceId?: StringFilter<"ActiveSession"> | string
  ...
  export type ActiveSessionScalarWhereWithAggregatesInput = {
    ...
    deviceId?: StringWithAggregatesFilter<"ActiveSession"> | string
